...
local modkey = require("bindings.mod").alt
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "Return", function()
		awful.spawn(util.external.terminal)
	end, { description = "open a terminal", group = "launcher" }),

	awful.key({ modkey }, "b", function()
		awful.spawn(util.external.browser)
	...
	awful.key({ modkey }, "Escape", function()
		awful.spawn(util.external.screen_locker)
	end, { description = "lock the screen", group = "launcher" }),

	awful.key({ modkey }, "e", function()
		awful.spawn(util.external.editor_cmd)
	...
	awful.key({
		...
		on_press = function()
			...
			local height = screen.geometry.height
			menubar.geometry = {
				x = 0.25 * width,
				y = 0.5 * height,
				width = 0.5 * width,
