...
set_hl("StatusLineFilepath", { italic = true, ctermfg = 8 })
...
set_hl("IndentBlankLineChar", { link = "IndentMarker", nocombine = true })
set_hl("IndentBlankLineContextChar", { link = "IndentMarker", nocombine = true })
set_hl("IblIndent", { link = "IndentMarker", nocombine = true })
set_hl("IblScope", { link = "IndentMarker", nocombine = true })
set_hl("IndentMarker", { ctermfg = 0 })
